...
# CAD Transform is vendored inside the rCAD Utils container addon.  Blender
# stores addon preferences under the top-level addon package, while this
# module lives one package below it.
...
def register_shortcuts():
    keymap = bpy.context.preferences.addons[ADDON_PACKAGE].preferences.keymap
